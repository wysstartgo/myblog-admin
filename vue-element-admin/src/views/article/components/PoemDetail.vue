    ...
    <el-form ref="postForm" :model="postForm" :rules="rules" class="form-container">
      ...
      <div class="createPost-main-container">
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item label-width="60px" label="Author:" class="postInfo-container-item">
                    <el-input v-model="postForm.author">author</el-input>
                  </el-form-item>
                </el-col>
        ...
        <el-form-item style="margin-bottom: 40px;" label-width="70px" label="Summary:">
          <el-input v-model="postForm.brief" :rows="1" type="textarea" class="article-textarea" autosize placeholder="Please enter the content" />
        ...
        <el-form-item prop="image_uri" style="margin-bottom: 30px;">
          <Upload v-model="postForm.contentImgUrl" />
        </el-form-item>
      </div>
    </el-form>
  </div>
...
import { fetchArticle, updateArticle } from '@/api/poem'
